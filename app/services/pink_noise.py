...
def generar_ruido_rosa(duracion: float, fs: int) -> np.ndarray:
    ...
    filtro = 1 / np.sqrt(frec + 1e-10)                # Agrega un numero pequeño para no dividir por cero
