...
RIR API calcula los cuatro estimadores ($EDT$, $T_{10}$, $T_{20}$, $T_{30}$) de forma independiente a partir de la respuesta al impulso integrada por el método de Schroeder.
...
nuestro0 = [0, 1, 2, 3, 4, 5]
catedra0 = [1, 2, 1, 2, 5, 1]
rew0 = [1.1, 1.01, 1.001, 1.0001, 1.00001, 1.000001]
referencia0 = [0, 0, 0, 0, 0, 0]

# Valores Gráfico 2 (T20)
nuestro1 = [0, 1, 2, 3, 4, 5]
catedra1 = [1, 2, 1, 2, 5, 1]
rew1 = [1.1, 1.01, 1.001, 1.0001, 1.00001, 1.000001]
referencia1 = [0, 0, 0, 0, 0, 0]

# Valores Gráfico 3 (T30)
nuestro2 = [0, 1, 2, 3, 4, 5]
catedra2 = [1, 2, 1, 2, 5, 1]
rew2 = [1.1, 1.01, 1.001, 1.0001, 1.00001, 1.000001]
referencia2 = [0, 0, 0, 0, 0, 0]
